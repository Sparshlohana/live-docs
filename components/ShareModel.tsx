        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                <Button className='gradient-blue flex h-9 gap-1 px-4' disabled={currentUserType !== "editor"}>
                    <Image src={"/assets/icons/share.svg"} alt='share' width={20} height={20} className='min-h-4 md:size-5' />
            ...
            <DialogContent className='shad-dialog'>
                ...
                <Label htmlFor='email' className='mt-6 text-blue-100'></Label>
                <div className='flex items-center gap-3'>
                    <div className='flex flex-1 rounded-md bg-dark-400'>
                        <Input id='email' placeholder='Enter Email Address' value={email} onChange={(e) => {
                    ...
                    <Button type='submit' onClick={shareDocument} className='gradient-blue flex h-full gap-1 px-5' disabled={loading}>
